...
tar_plan(
  ...
  #
  # ** Look into using the solnp function from the Rsolnp package
  ...
  # Re-written solver that uses binary search instead. 
  # This one is much, much better. Apparently my grid searches were 
  # trash all along and slow as all hell. 
