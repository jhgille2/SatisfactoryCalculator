...
#' @param recipeGraph
#' @param products
clean_constrained_lp_results <- function(lp_result = constrained_LP_result, recipeData =
  ...
  itemConsumptionMatrix <- t(make_recipeMatrix(names(products), recipeGraph = recipeGraph, recipeData = recipeData, itemMode = "component")) * lp_result$par
